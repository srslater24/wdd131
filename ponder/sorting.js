...
function compareFn(a,b) { // use as starting point. change to length of hike. a and b are objecsts. if i need to access length part (distance), a.distance compare b.distance.
